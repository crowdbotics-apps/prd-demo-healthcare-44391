...
## Project Structure
    ...
    ├── prd_demo_healthcare_44391  # Django project configurations
...
1. Clone this repo and `cd prd_demo_healthcare_44391`
...
2. Clone this repo and `cd prd_demo_healthcare_44391`
